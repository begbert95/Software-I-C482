...
import src.softwareic482.InHouse;
import src.softwareic482.Inventory;
import src.softwareic482.Main;
import src.softwareic482.Outsourced;
...
/*
    public void start () throws Exception{
        setPartID();
        disableSourceFields();
        Parent root = FXMLLoader.load(getClass().getResource("/view/EditPartView.fxml"));
    ...
    public void start (Stage stage) throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HomeController.class.getResource("/view/EditPartView.fxml"));
